 ...
 * Get Criteria
 */
export const getCriteriaApiVersusCriteriaGet = <ThrowOnError extends boolean = false>(options?: Options<GetCriteriaApiVersusCriteriaGetData, ThrowOnError>) => (options?.client ?? client).get<GetCriteriaApiVersusCriteriaGetResponses, unknown, ThrowOnError>({ url: '/api/versus/criteria', ...options });
