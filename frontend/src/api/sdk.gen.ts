 ...
 * view.
 */
export const getQuestionTrajectoryApiAtlasPagesQuestionIdTrajectoryGet = <ThrowOnError extends boolean = false>(options: Options<GetQuestionTrajectoryApiAtlasPagesQuestionIdTrajectoryGetData, ThrowOnError>) => (options.client ?? client).get<GetQuestionTrajectoryApiAtlasPagesQuestionIdTrajectoryGetResponses, GetQuestionTrajectoryApiAtlasPagesQuestionIdTrajectoryGetErrors, ThrowOnError>({ url: '/api/atlas/pages/{question_id}/trajectory', ...options });
