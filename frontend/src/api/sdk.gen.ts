 ...
 */
export const listProjectRunsSummaryApiProjectsProjectIdRunsSummaryGet = <ThrowOnError extends boolean = false>(options: Options<ListProjectRunsSummaryApiProjectsProjectIdRunsSummaryGetData, ThrowOnError>) => (options.client ?? client).get<ListProjectRunsSummaryApiProjectsProjectIdRunsSummaryGetResponses, ListProjectRunsSummaryApiProjectsProjectIdRunsSummaryGetErrors, ThrowOnError>({ url: '/api/projects/{project_id}/runs-summary', ...options });

/**
 * List Project Boundary Exchanges
 *
 ...
 */
export const listProjectBoundaryExchangesApiProjectsProjectIdLlmBoundaryExchangesGet = <ThrowOnError extends boolean = false>(options: Options<ListProjectBoundaryExchangesApiProjectsProjectIdLlmBoundaryExchangesGetData, ThrowOnError>) => (options.client ?? client).get<ListProjectBoundaryExchangesApiProjectsProjectIdLlmBoundaryExchangesGetResponses, ListProjectBoundaryExchangesApiProjectsProjectIdLlmBoundaryExchangesGetErrors, ThrowOnError>({ url: '/api/projects/{project_id}/llm-boundary-exchanges', ...options });

/**
 * Get Boundary Exchange
 *
 * Fetch one boundary exchange row including full request_json + response_json.
 */
export const getBoundaryExchangeApiLlmBoundaryExchangesExchangeIdGet = <ThrowOnError extends boolean = false>(options: Options<GetBoundaryExchangeApiLlmBoundaryExchangesExchangeIdGetData, ThrowOnError>) => (options.client ?? client).get<GetBoundaryExchangeApiLlmBoundaryExchangesExchangeIdGetResponses, GetBoundaryExchangeApiLlmBoundaryExchangesExchangeIdGetErrors, ThrowOnError>({ url: '/api/llm-boundary-exchanges/{exchange_id}', ...options });
 ...
 */
export const getOrchestratorInfoApiOrchestratorsVariantGet = <ThrowOnError extends boolean = false>(options: Options<GetOrchestratorInfoApiOrchestratorsVariantGetData, ThrowOnError>) => (options.client ?? client).get<GetOrchestratorInfoApiOrchestratorsVariantGetResponses, GetOrchestratorInfoApiOrchestratorsVariantGetErrors, ThrowOnError>({ url: '/api/orchestrators/{variant}', ...options });
 ...
 */
export const postDispatchCallApiQuestionsQuestionIdDispatchPost = <ThrowOnError extends boolean = false>(options: Options<PostDispatchCallApiQuestionsQuestionIdDispatchPostData, ThrowOnError>) => (options.client ?? client).post<PostDispatchCallApiQuestionsQuestionIdDispatchPostResponses, PostDispatchCallApiQuestionsQuestionIdDispatchPostErrors, ThrowOnError>({
 ...
 * List Nudges
 */
export const listNudgesApiRunsRunIdNudgesGet = <ThrowOnError extends boolean = false>(options: Options<ListNudgesApiRunsRunIdNudgesGetData, ThrowOnError>) => (options.client ?? client).get<ListNudgesApiRunsRunIdNudgesGetResponses, ListNudgesApiRunsRunIdNudgesGetErrors, ThrowOnError>({ url: '/api/runs/{run_id}/nudges', ...options });

/**
 * Create Nudge
 */
export const createNudgeApiRunsRunIdNudgesPost = <ThrowOnError extends boolean = false>(options: Options<CreateNudgeApiRunsRunIdNudgesPostData, ThrowOnError>) => (options.client ?? client).post<CreateNudgeApiRunsRunIdNudgesPostResponses, CreateNudgeApiRunsRunIdNudgesPostErrors, ThrowOnError>({
 ...
 * Revoke Nudge
 */
export const revokeNudgeApiNudgesNudgeIdRevokePatch = <ThrowOnError extends boolean = false>(options: Options<RevokeNudgeApiNudgesNudgeIdRevokePatchData, ThrowOnError>) => (options.client ?? client).patch<RevokeNudgeApiNudgesNudgeIdRevokePatchResponses, RevokeNudgeApiNudgesNudgeIdRevokePatchErrors, ThrowOnError>({ url: '/api/nudges/{nudge_id}/revoke', ...options });

/**
 * List Alert Configs
 */
export const listAlertConfigsApiAlertConfigsGet = <ThrowOnError extends boolean = false>(options?: Options<ListAlertConfigsApiAlertConfigsGetData, ThrowOnError>) => (options?.client ?? client).get<ListAlertConfigsApiAlertConfigsGetResponses, ListAlertConfigsApiAlertConfigsGetErrors, ThrowOnError>({ url: '/api/alert-configs', ...options });

/**
 * Create Alert Config
 */
export const createAlertConfigApiAlertConfigsPost = <ThrowOnError extends boolean = false>(options: Options<CreateAlertConfigApiAlertConfigsPostData, ThrowOnError>) => (options.client ?? client).post<CreateAlertConfigApiAlertConfigsPostResponses, CreateAlertConfigApiAlertConfigsPostErrors, ThrowOnError>({
 ...
 * Delete Alert Config
 */
export const deleteAlertConfigApiAlertConfigsConfigIdDelete = <ThrowOnError extends boolean = false>(options: Options<DeleteAlertConfigApiAlertConfigsConfigIdDeleteData, ThrowOnError>) => (options.client ?? client).delete<DeleteAlertConfigApiAlertConfigsConfigIdDeleteResponses, DeleteAlertConfigApiAlertConfigsConfigIdDeleteErrors, ThrowOnError>({ url: '/api/alert-configs/{config_id}', ...options });

/**
 * Get Run Alerts
 */
export const getRunAlertsApiRunsRunIdAlertsGet = <ThrowOnError extends boolean = false>(options: Options<GetRunAlertsApiRunsRunIdAlertsGetData, ThrowOnError>) => (options.client ?? client).get<GetRunAlertsApiRunsRunIdAlertsGetResponses, GetRunAlertsApiRunsRunIdAlertsGetErrors, ThrowOnError>({ url: '/api/runs/{run_id}/alerts', ...options });
 ...
 */
export const getQuestionInlaysApiQuestionsQuestionIdInlaysGet = <ThrowOnError extends boolean = false>(options: Options<GetQuestionInlaysApiQuestionsQuestionIdInlaysGetData, ThrowOnError>) => (options.client ?? client).get<GetQuestionInlaysApiQuestionsQuestionIdInlaysGetResponses, GetQuestionInlaysApiQuestionsQuestionIdInlaysGetErrors, ThrowOnError>({ url: '/api/questions/{question_id}/inlays', ...options });
