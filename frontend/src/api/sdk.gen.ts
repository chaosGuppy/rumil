 ...
 * List Ab Evals
 */
export const listAbEvalsApiAbEvalsGet = <ThrowOnError extends boolean = false>(options?: Options<ListAbEvalsApiAbEvalsGetData, ThrowOnError>) => (options?.client ?? client).get<ListAbEvalsApiAbEvalsGetResponses, unknown, ThrowOnError>({ url: '/api/ab-evals', ...options });
