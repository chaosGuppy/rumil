 ...
 * List Recent Runs
 */
export const listRecentRunsApiAdminRunsGet = <ThrowOnError extends boolean = false>(options?: Options<ListRecentRunsApiAdminRunsGetData, ThrowOnError>) => (options?.client ?? client).get<ListRecentRunsApiAdminRunsGetResponses, ListRecentRunsApiAdminRunsGetErrors, ThrowOnError>({ url: '/api/admin/runs', ...options });
