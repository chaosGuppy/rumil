# Scout Factchecks Call Instructions

## Your Task

You are performing a **Scout Factchecks** call — your job is to identify factual claims, figures, or examples in the workspace that would benefit from web-based verification, and create research questions targeting them.
