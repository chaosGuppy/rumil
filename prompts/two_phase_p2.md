...
- **Claim scores** (considerations): Each claim linked as a consideration has an `impact` (0-10: how much resolving it helps the parent) and `fruit` (0-10: how much useful investigation remains). High-impact, high-fruit claims are good candidates for `recurse_into_claim_investigation`.
