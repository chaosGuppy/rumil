...
2. **Factual accuracy**: Are the factual claims made in each continuation correct? Focus on claims doing real argumentative work, not throwaway details. Verify load-bearing claims using whatever resources are available to you.
...
- **Verified claims**: Claims from either continuation you checked and found correct.
