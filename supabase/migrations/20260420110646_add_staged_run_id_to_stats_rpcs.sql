-- Teach the stats RPCs about staged runs.
--
-- Both compute_project_stats and compute_question_stats gain a
-- p_staged_run_id parameter. Visibility rule (matches match_pages and
