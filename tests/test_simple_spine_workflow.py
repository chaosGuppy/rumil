...
def _wf(*, artifacts: dict[str, str] | None = None) -> SimpleSpineWorkflow:
    ...
    wf = SimpleSpineWorkflow(
        budget_usd=40_000, config_name="research", call_type="judge", artifacts=artifacts
    )
...
def test_constructor_default_artifacts_empty():
    wf = SimpleSpineWorkflow(budget_usd=40_000, config_name="research", call_type="judge")
    assert wf.artifacts == {}
